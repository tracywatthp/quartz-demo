package com.tinxi.common.codegenerator;
...
public class TableGenerator {
	...
	public static void init(){
		...
		try {
			prop = PropertiesLoaderUtils.loadAllProperties("config/init.properties");
			if(prop!=null){
	...
	public static void execute(){
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new GlobalConfig()
                        ...
                        .setAuthor(prop.getProperty("auther"))				//作者
...
//                        })
                ...
                new PackageConfig()
                        ...
                        .setEntity("bean")													//这里是javabean包名，默认entity
        ).setCfg( 
